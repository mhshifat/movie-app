...
const ActorInfo: React.FC<Props> = ({ actor }) => {
  return (
    <div className="actor-info border-b border-gray-400">
      <div className="container mx-auto px-4 py-16 flex flex-col md:flex-row ">
        <div className="flex-none">
          ...
          <ul className="flex items-center mt-4">
            <li>
              <a
                title="Facebook"
                href={"https://www.facebook.com/" + actor?.facebook_id}
                target="_blank"
                rel="noreferrer"
                className="mr-12"
              >
        ...
        <div className="md:ml-24 ">
          ...
          <p className="text-gray-300 mt-8">{actor?.biography}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-5 gap-8">
            {actor?.credits?.cast
              ...
              .map((item: any) => (
                <div className="mt-4" key={item?.credit_id}>
